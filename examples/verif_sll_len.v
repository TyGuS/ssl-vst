...
Definition sll_len_spec :=
  DECLARE _sll_len
   ...
   PROP(  )
   LOCAL()
   SEP ((data_at Tsh (tarray (Tunion _sslval noattr) 1) [(inl ((Vint (Int.repr n)) : val))] (r : val)); (sll (x : val) (n : Z) (lo : Z) (hi : Z) (_alpha_515 : sll_card))).
...
Definition Gprog : funspecs :=
  ltac:(with_library prog [sll_len_spec]).

Lemma body_sll_len : semax_body Vprog Gprog f_sll_len sll_len_spec.
Proof.
start_function.
ssl_open_context.
